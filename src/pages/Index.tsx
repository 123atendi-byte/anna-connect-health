...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[hsl(var(--hero-bg))] to-[hsl(var(--hero-bg-end))] pt-24 pb-40 md:pt-32 md:pb-20 lg:pt-40 lg:pb-32">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-5xl mx-auto text-center sm:text-left md:text-center">
            ...
            <motion.div 
              className="flex flex-wrap justify-center gap-3 md:gap-4 mb-16 md:mb-8"
            ...
            <motion.h1 
              className="text-xl md:text-4xl lg:text-5xl font-bold text-foreground mb-16 md:mb-6 leading-tight"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <motion.p 
              className="text-sm sm:text-base md:text-lg text-muted-foreground mb-20 md:mb-10 leading-relaxed max-w-3xl mx-auto px-2"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            <motion.div
              ...
              className="px-4 flex flex-col sm:flex-row gap-4 items-center justify-center mb-12 md:mb-0"
            >
              <Button
                size="lg"
